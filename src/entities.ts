...
import type { GameState, CanvasSize } from './types';

export function spawnHelicopter(state: GameState, canvas: CanvasSize, forceDir?: number): void {
...
export function spawnJet(state: GameState, canvas: CanvasSize): void {
